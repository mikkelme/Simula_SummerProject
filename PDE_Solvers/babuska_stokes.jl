...
function babuska_stokes_solver(model, pgs_dict, f0, g0, h0, write=false)
    ...
    M = TrialFESpace(δM)
    Λ = TrialFESpace(δΛ, VectorValue(0, 0))
...
babuska_stokes_solver(model, pgs_dict, f0, g0, σ)
