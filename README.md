...
\begin{align}
    ...
    & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \enspace \quad + \int\_{\Gamma} P_D \Big[\hat{n}_S \cdot v_S \Big] + \alpha \Big[u_S \cdot\hat{\tau}_S \Big]\Big[\hat{\tau}_S \cdot v_S \Big] \ dx
\end{align}
$$
